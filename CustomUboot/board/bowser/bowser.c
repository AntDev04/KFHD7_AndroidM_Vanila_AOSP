...
#define MUX_DEFAULT_OMAP4_ALL() \
	...
	MV(CP(C2C_DATA11),	(M7_SAFE)) /* board_id1 */ \
	MV(CP(C2C_DATA12),	(M7_SAFE)) /* board_id2 */ \
	MV(CP(C2C_DATA13),	(M7_SAFE)) /* board_id3 */ \
	MV(CP(C2C_DATA14),	(M7_SAFE)) /* board_id4 */ \
...
void set_muxconf_regs(void)
{
	...
	MUX_DEFAULT_OMAP4(); //Tate initializes pin mux in X-loader.
#endif

#if defined(CONFIG_MACH_BOWSER_SUBTYPE_TATE)
	MUX_SCO();//Enable PIN MUX for BT SCO
#endif
	return;
}
