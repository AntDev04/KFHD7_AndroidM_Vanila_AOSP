...
#define PHOENIX_STS_HW_CONDITION	0x21
#define TWL6030_PHONIX_DEV_ON		0x25

/* PHOENIX_DEVON_MASK */
#define PHONIX_APP_DEVOFF	(1 << 0)
#define PHONIX_CON_DEVOFF	(1 << 1)
#define PHONIX_MOD_DEVOFF	(1 << 2)
#define PHONIX_SW_RESET		(1 << 6)


void twl6030_init_battery_charging(void);
void twl6030_usb_device_settings(void);
int twl6030_i2c_read_u8(u8 chip_no, u8 *val, u8 reg);
